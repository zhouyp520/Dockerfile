...
#Define DOMAIN_HOME
export DOMAIN_HOME=/wls11/bea12c/oracle/user_projects/domains/$DOMAIN_NAME
...
if [ $ADD_DOMAIN -eq 0 ]; then
   PROPERTIES_FILE=/wls11/bea12c/oracle/properties/domain.properties
   ...
   wlst.sh -skipWLSModuleScanning -loadProperties $PROPERTIES_FILE  /wls11/bea12c/oracle/create-wls-domain.py
